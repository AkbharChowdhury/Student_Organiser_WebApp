...
<div class="container py-5">
    <?= Helper::breadcrumb(page: 'Edit Semester', homeLink: 'admin_dashboard.php') ?>
    ...
    <form class="row g-3 needs-validation" action="" method="post" autocomplete="off" novalidate>
        <div class="col-md-8">
            ...
            <input type="text" class="form-control" id="type" name="semester_name"
                   placeholder="Enter semester description"
                   value="<?= $_POST['semester_name'] ?? $semesterData['semester_name'] ?>" autofocus required>
        ...
        <div class="col-md-8">
            ...
            <input type="datetime" class="form-control" id="start" name="start_date" placeholder="Start date"
                   value="<?= $_POST['start_date'] ?? $semesterData['start_date'] ?>">
        ...
        <div class="col-md-8">
            ...
            <input type="datetime" class="form-control" id="end" name="end_date" placeholder="End date"
                   value="<?= $_POST['end_date'] ?? $semesterData['end_date'] ?>">
