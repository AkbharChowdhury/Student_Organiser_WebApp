...
<div class="container">
    ...
    <form class="row g-3 needs-validation" action="" method="post" autocomplete="off" novalidate>
        ...
        <div class="col-12">
            ...
            <input type="text" class="form-control" id="title" name="title" maxlength="100" placeholder="Enter coursework title" required>
        ...
        <div class="col-12">
            ...
            <input type="color" class="form-control form-control-color" id="colour_tag" name="colour_tag" value="<?= Helper::getDefaultColour() ?>" title="Choose your color">
        </div>
        <div class="col-md-6">
            <label for="due_date" class="form-label">Coursework Due Date & time <span class="text-danger">*</span></label>
            <input type="text" class="form-control due_dates" id="due_date" name="due_date" maxlength="100" placeholder="Enter coursework due date" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="checklist_title[]" placeholder="Title">
                                            <label>Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="form-floating">
                                            <input type="datetime-checklist" class="form-control" name="checklist_due_date[]" placeholder="Due date & time">
